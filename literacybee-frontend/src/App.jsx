    ...
    <Provider store={store}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/child/dashboard" element={<PrivateRoute allowedRoles={['child']}><ChildDashboard /></PrivateRoute>} />
          <Route path="/child/lesson/:lessonId" element={<PrivateRoute allowedRoles={['child']}><LessonPage /></PrivateRoute>} />
        </Routes>
      </BrowserRouter>
    </Provider>
  );
